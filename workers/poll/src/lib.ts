...
/** Favicon SVG inline (data-URI) — marca "d.." em branco sobre teal (marca),
 * mesma marca usada em cursos/livros. Os dois pontos são o period do Georgia
 * (redondo). Trocar o favicon faz o browser tratar como página diferente —
 * mudança intencional aqui (alinhamento à marca d..). Cores hardcoded como
