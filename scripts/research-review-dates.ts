...
function parseArgs(argv: string[]): Args {
  // #2834: consumo de valor incondicional no parser local original
  // (argv[++i] pega o próximo token mesmo que comece com "--") →
  // parseArgsSimple replica isso exatamente. O throw de campo obrigatório
  // ausente é fail-fast preservado (nenhuma canônica substitui validação).
