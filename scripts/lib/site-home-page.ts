...
<title>diar.ia.br — notícias de IA todo dia, em português</title>
...
<link rel="alternate" type="application/rss+xml" title="diar.ia.br — Feed RSS" href="https://diar.ia.br/feed.xml">
...
/* Logo (nav em si é o componente compartilhado renderSiteNav, #8497 — CSS
   embutido no próprio helper, não duplicado aqui) */
.logo-bar { padding: 18px 0; }
...
<body>
  <!-- #8497: menu global compartilhado (scripts/lib/shared/site-nav.ts) —
       antes disso este bloco era markup PRÓPRIO da home (único lugar do
       site com nav), com os mesmos 6 itens + CTA "Assinar" escritos à mão
       (histórico: #8353 item 2 — "Edições" aponta pro índice do PRÓPRIO
       apex; #7915 — "Apoiar" como link secundário, "Assinar" como único
       CTA primário; #6978 itens 2/3 — decisão de NÃO ter "Entrar"/busca,
       ver rationale no PR original #6995/#6978, preservado no histórico do
       módulo compartilhado). A logo (renderWordmark()) fica FORA do
       componente compartilhado — só a home a repete junto da nav; as
       demais páginas têm cabeçalho próprio. -->
  <div class="logo-bar"><div class="wrap"><div class="logo">${renderWordmark()}</div></div></div>
