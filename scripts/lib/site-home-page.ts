  ...
  <nav class="nav" id="nav">
    <div class="wrap">
      ...
      <div class="nav-links">
        ...
        <!-- #7915: link secundário pra /apoiar — "Assinar" (grátis) segue
             sendo o ÚNICO botão/CTA primário da nav (.nav-cta abaixo); este
             é um link de texto entre os demais, mesmo peso visual de
             "Edições"/"Especiais". -->
