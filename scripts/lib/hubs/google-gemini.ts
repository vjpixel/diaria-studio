...
export function buildGoogleGeminiFaq(sources: HubSourceEntry[]): GeoFaqItem[] {
  ...
  return [
    ...
    {
      question: "Quantos lançamentos de modelo ou ferramenta o Google teve nesse período, segundo a diária?",
      answer: `A diária noticiou ${launches} lançamentos entre 03/09/2025 e 22/07/2026, em 3 surtos separados por hiatos, um deles de 84 dias, o mais longo do período. Os 3 surtos estão detalhados na seção acima.`,
    },
    {
      question: "O Gemini já \"venceu\" o ChatGPT, segundo a cobertura da diária?",
      answer: `A palavra "ChatGPT" apareceu ao lado do Gemini em ${chatgpt} manchetes diferentes, incluindo uma pergunta direta, ["O Gemini venceu o ChatGPT?"](https://diar.ia.br/p/o-gemini-venceu-o-chatgpt), que a própria diária nunca respondeu com um "sim" categórico. A seção acima cobre a virada de narrativa completa, do Google "ameaçado" à disputa ampliada para outros rivais.`,
    },
    {
    ...
    {
      question: "O Google já usou IA para resolver um problema de saúde real, segundo a diária?",
    ...
    },
    {
      ...
      answer: `A diária noticiou ${educacao} iniciativas de formação em IA ao longo de 5 meses, de treinamento em cinema a curso online aos sábados. A seção acima traz a cronologia completa, incluindo o fechamento do arco quase um ano depois.`,
    },
    {
      question: "Qual foi o maior investimento em infraestrutura de IA que o Google anunciou no período?",
      answer: `O maior número citado foi US$ 15 bilhões, [anunciado em 19 de fevereiro de 2026](https://diar.ia.br/p/lula-na-maior-cupula-global-de-ia-bde9c122905d2d79), mas a diária registrou ${investe} manchetes de investimento direto (sem contar o hardware próprio e o fundo no Brasil, cobertos na seção acima).`,
    },
    {
      question: "Por que o tamanho do Google no mercado de buscas virou motivo de alarme regulatório?",
      answer: `Em 9 dias de julho de 2026, a diária publicou ${regulatorio} manchetes que, lidas juntas, explicam o alarme: a União Europeia forçando o Google a abrir dados para rivais, editoras cogitando banir o buscador e um estudo mostrando a IA do Google dominando 43% das buscas nos EUA. A seção acima detalha a sequência.`,
    },
    {
