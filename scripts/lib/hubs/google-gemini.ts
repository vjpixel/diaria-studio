...
export function buildGoogleGeminiFaq(sources: HubSourceEntry[]): GeoFaqItem[] {
  ...
  return [
    ...
    },
    {
      ...
      answer: `A diar.ia.br noticiou ${launches} lançamentos entre 27/08/2025 e 22/07/2026, em 3 surtos separados por hiatos, um deles de 84 dias, o mais longo do período. Os 3 surtos estão detalhados na seção acima.`,
    },
    {
