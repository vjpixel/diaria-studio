...
export function buildGoogleGeminiFaq(sources: HubSourceEntry[]): GeoFaqItem[] {
  ...
  return [
    {
      question: "Em quantas edições a diar.ia.br destacou algo sobre Google ou Gemini?",
    ...
    {
      question: "Quantos lançamentos de modelo ou ferramenta o Google teve nesse período, segundo a diar.ia.br?",
      answer: `A diar.ia.br noticiou ${launches} lançamentos entre 03/09/2025 e 22/07/2026, em 3 surtos separados por hiatos, um deles de 84 dias, o mais longo do período. Os 3 surtos estão detalhados na seção acima.`,
    },
    {
      question: "O Gemini já \"venceu\" o ChatGPT, segundo a cobertura da diar.ia.br?",
      answer: `A palavra "ChatGPT" apareceu ao lado do Gemini em ${chatgpt} manchetes diferentes, incluindo uma pergunta direta, ["O Gemini venceu o ChatGPT?"](https://diar.ia.br/p/o-gemini-venceu-o-chatgpt), que a própria diar.ia.br nunca respondeu com um "sim" categórico. A seção acima cobre a virada de narrativa completa, do Google "ameaçado" à disputa ampliada para outros rivais.`,
    },
    {
      question: "Quantas vezes o Gemini foi anunciado como novidade chegando ao Brasil?",
      answer: `Pelo menos ${brasil} manchetes trataram o Brasil como destino de um lançamento ou investimento do Google, incluindo um caso em que [a mesma função chegou ao país duas vezes com nomes diferentes](https://diar.ia.br/p/nvidia-anuncia-investimento-de-us-100-bi-na-openai), com 14 dias de intervalo. A seção acima detalha a sequência completa.`,
    },
    {
    ...
    {
      question: "O Google já usou IA para resolver um problema de saúde real, segundo a diar.ia.br?",
      answer: `Sim, a cobertura registrou ${saude} casos concretos: [um sistema do Google igualando médicos em teste clínico](https://diar.ia.br/p/sistema-do-google-iguala-m-dicos-em-teste) e, 26 dias depois, [a mesma IA detectando um câncer raro dentro do SUS](https://diar.ia.br/p/ia-do-google-detecta-c-ncer-raro-no-sus). A seção acima coloca isso na escalada mais ampla, que começa em pesquisa pura de ciência.`,
    },
    {
      question: "Quantos cursos gratuitos de IA o Google já ofereceu no Brasil?",
      answer: `A diar.ia.br noticiou ${educacao} iniciativas de formação em IA ao longo de 5 meses, de treinamento em cinema a curso online aos sábados. A seção acima traz a cronologia completa, incluindo o fechamento do arco quase um ano depois.`,
    },
    {
      question: "Qual foi o maior investimento em infraestrutura de IA que o Google anunciou no período?",
      answer: `O maior número citado foi US$ 15 bilhões, [anunciado em 19 de fevereiro de 2026](https://diar.ia.br/p/lula-na-maior-cupula-global-de-ia-bde9c122905d2d79), mas a diar.ia.br registrou ${investe} manchetes de investimento direto (sem contar o hardware próprio e o fundo no Brasil, cobertos na seção acima).`,
    },
    {
      question: "Por que o tamanho do Google no mercado de buscas virou motivo de alarme regulatório?",
      answer: `Em 9 dias de julho de 2026, a diar.ia.br publicou ${regulatorio} manchetes que, lidas juntas, explicam o alarme: a União Europeia forçando o Google a abrir dados para rivais, editoras cogitando banir o buscador e um estudo mostrando a IA do Google dominando 43% das buscas nos EUA. A seção acima detalha a sequência.`,
    },
    {
      question: "Como acompanho as próximas notícias sobre Google e Gemini?",
      answer:
        "Assine a diar.ia.br. A newsletter cobre lançamentos, expansão de produto e movimentos regulatórios do Google conforme acontecem, de segunda a sexta, e esta página é atualizada periodicamente para refletir a cobertura mais recente.",
    },
  ];
}
...
const INTRO =
  'Entre 3 de setembro de 2025 e 30 de julho de 2026, o Google e o Gemini foram destaque em 61 edições da diar.ia.br, 69 manchetes ao todo, quase uma menção a cada 5 dias corridos ao longo de 11 meses. Olhando o arquivo inteiro, não uma edição isolada, um padrão salta aos olhos: os lançamentos de modelo não vêm num fluxo parelho, vêm em 3 surtos separados por hiatos, o mais longo deles de 84 dias entre fevereiro e maio de 2026. A cobertura também acompanhou uma inversão de narrativa: um Google descrito como ameaçado pelos resultados da OpenAI em novembro de 2025 virou, cerca de 4 meses e meio depois, um Google apostando abertamente contra Meta e DeepSeek também. No Brasil, o Gemini foi anunciado como novidade em pelo menos 6 manchetes diferentes, do AI Mode em setembro de 2025 a um fundo de investimento local em junho de 2026, incluindo um caso em que a mesma função chegou ao país duas vezes, com nomes diferentes, em 2 semanas de intervalo. Do lado da aplicação prática, o Gemini foi de "resolve o insolúvel na ciência" a detectar câncer raro dentro do SUS. O período termina em tensão: em 9 dias de julho de 2026, a diar.ia.br cobriu a União Europeia forçando o Google a abrir dados para rivais, editoras cogitando banir o buscador e um estudo mostrando que a IA do Google já domina 43% das buscas nos EUA. As seções abaixo detalham cada um desses pontos, com data e fonte.';
...
export function getGoogleGeminiHub(): HubContent {
  return {
    ...
    metaDescription:
      "O que a diar.ia.br cobriu sobre Google e Gemini entre setembro de 2025 e julho de 2026: ritmo de lançamento de modelo, expansão pelo Brasil, a disputa com o ChatGPT, usos em saúde e o início do alarme regulatório.",
    introHeading: "O que aconteceu com o Google e o Gemini desde setembro de 2025, segundo a diar.ia.br?",
    introParagraph: INTRO,
    sections: [
      {
        heading: "Com que ritmo o Google lança modelo novo de Gemini (e de Nano Banana)?",
        paragraphs: [
          "A diar.ia.br noticiou 10 lançamentos de modelo ou ferramenta do Google entre 3 de setembro de 2025 e 22 de julho de 2026, mas o ritmo não foi constante: vieram em 3 surtos separados por 2 hiatos, um deles o mais longo de todo o período coberto por este hub. No primeiro surto, 5 lançamentos couberam em 107 dias: [Gemini 2.5 Flash Image](https://diar.ia.br/p/google-lan-a-gemini-2-5-flash-image), [o Veo 3.1](https://diar.ia.br/p/google-veo-3-1), [o próprio Gemini 3](https://diar.ia.br/p/tudo-sobre-gemini-3), [Nano Banana Pro](https://diar.ia.br/p/sao-paulo-oferece-cursos-de-ia-gratuitos) e [Gemini 3 Flash](https://diar.ia.br/p/openai-cria-treinamento-gratuito-para-jornalistas).",
          "Depois veio um hiato de 63 dias sem nenhum lançamento novo, de 19 de dezembro de 2025 a 20 de fevereiro de 2026. Nessa janela a cobertura girou em torno da disputa com o ChatGPT (seção abaixo), não de produto novo. O segundo surto foi o mais compacto de todos: [Gemini 3.1 Pro](https://diar.ia.br/p/novo-curso-de-ia-do-google) e [Nano Banana 2](https://diar.ia.br/p/claude-opus-3-se-aposenta-e-vira-blogueiro) saíram com apenas 6 dias de diferença entre si.",
          "O hiato seguinte foi o mais longo do período: 84 dias entre o Nano Banana 2 e o [lançamento do Gemini Omni no Google I/O](https://diar.ia.br/p/google-lan-a-gemini-omni-no-google-i-o), em 21 de maio de 2026. O terceiro e último surto coberto por este hub fechou num ritmo parecido com o primeiro: [Nano Banana 2 Lite](https://diar.ia.br/p/anthropic-lan-a-sonnet-5), 41 dias depois do Omni, e o [lançamento em trio de Gemini 3.6 e 3.5 Flash](https://diar.ia.br/p/google-lanca-trio-gemini-3-6-e-3-5-flash), mais 21 dias depois: 3 lançamentos em 62 dias.",
        ],
      },
      {
