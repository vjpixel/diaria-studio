 ...
 * `buildIntro` nos 5 hubs anteriores). Array de 2 elementos (#5259) — o
 * orçamento de ~250 palavras não cabe no teto de 160 por parágrafo
 * (`HUB_MAX_PARAGRAPH_WORDS`) numa unidade só; quebra no ponto natural entre
 * "o que aconteceu" (demissões) e "o que os estudos/empresas dizem". */
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Em 1º de setembro de 2026, [Bill Gates propôs o conceito de "Human Reserved": atividades que a sociedade escolhe manter só para humanos, mesmo quando uma máquina daria conta](https://diar.ia.br/p/gates-propoe-empregos-so-para-humanos). O exemplo dele é o cuidado com o próprio pai, com Alzheimer até morrer em 2020, e a proposta vem com taxar tokens de IA e robôs — hoje sai mais barato demitir e comprar máquina. É a família de resposta que Amodei já defendia ao falar em redistribuição de renda, com a pergunta deslocada: em vez de quantos empregos a IA consegue tirar, quais a sociedade decide não deixar que ela tire. Uma é previsão técnica; a outra é escolha política, decidida setor por setor.',
        ],
      },
    ],
