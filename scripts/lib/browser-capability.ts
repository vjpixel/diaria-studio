 ...
 *     `data/`.
 *
 * A confusão dos dois eixos é a causa raiz do #5208: `300` (servidor
 ...
 * módulo: eles rodam num único processo (tipicamente Linux, `300`) mas
 ...
 *   `'unavailable'` (sessão headless — é o caso motivador, `300`, #5208).
