 ...
 * que os publicadores exigem) e `_internal/05-edition-url.txt` (URL da
 * retrospectiva, a que os textos curtos citam) — para que os publicadores da
 * diária rodem sobre ele sem modificação.
 *
 ...
 *
 * `--start` (AAMMDD): primeiro dia possível; default = amanhã no horário de
 * Brasília. Os dias efetivos são os sábados e domingos a partir dele.
 *
