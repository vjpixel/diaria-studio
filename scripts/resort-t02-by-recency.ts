 ...
 *
 * Output: data/clarice-subscribers/stripe-export-t02-ex-assinantes.csv reordenado (overwrite).
 * Backup: data/clarice-subscribers/stripe-export-t02-ex-assinantes.csv.bak-score-sorted
 */
...
function main() {
  ...
  const t02Path = `${ROOT}/stripe-export-t02-ex-assinantes.csv`;
