...
:root {
  /* #4001: Studio sempre em tema claro, independente da preferência do
     sistema/browser (reverte o dark mode do #3876) — sem isso, controles
     nativos (inputs, scrollbars, selects) ainda renderizam escuros em
     aparelho com preferência dark mesmo com o resto do CSS claro. */
  color-scheme: light;
  --brand: ${colors.brand};
  --ink: ${colors.ink};
  --paper: ${colors.paper};
