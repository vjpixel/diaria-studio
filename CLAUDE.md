...
- **Sonnet 5** (#2745) — `writer`, `writer-destaque`, `writer-monthly`, `publish-social`, `social-linkedin`, `social-facebook`, `fact-checker`. (`publish-newsletter` migrou pra playbook lido pelo top-level em #1054; movido pra `context/publishers/beehiiv-playbook.md` em #1114.)
