...
**Máquina escolhida pelo editor (260811): `300`** — mesma máquina do sync das 08:30 (`Diaria-Clarice-Sync`) e do `Diaria-Clarice-Novos` das 09:00 (#5447, antes 11:00 do #5140, antes 17:00), o que elimina o atraso do OneDrive na leitura do store pra este par e mantém as três tasks Clarice na mesma máquina.
