...
3. **Rótulos residuais em inglês** (eixo genérico desde #6498 — checa qualquer rótulo comum de UI em inglês, não mais amarrado ao vocabulário do antigo tema Beehiiv) — ex: "Sign Up", "Login"/"Log in", "N min read", "Subscribe", "Read more", "Get started". Casado contra o texto RENDERIZADO (`extractVisibleText`, #5137) — dado de configuração de algum builder/widget embutido no HTML (ex: `"label":"Sign Up"` num payload JSON) não conta, só texto que o leitor de fato vê.
