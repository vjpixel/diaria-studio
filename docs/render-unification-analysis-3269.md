...
| UTM `clarice-{ciclo}` injetado em todo link `diaria.beehiiv.com` (`withClariceUtm`/`setMonthlyUtmCiclo`, só mensal) | Necessidade de atribuição específica da migração Clarice→diar.ia.br (#2975); não existe no diário. |
