...
| `title-picker` | opus 4.7 → Sonnet (#2772, 260701) | fallback 1×/edição | **Manter** | Escolha 1-de-3 títulos com raciocínio sobre concretude + CTR. Opus deliberado por alto impacto editorial (#159). |
