...
**Armado e confirmado ativo em `300` (260814):** `systemctl --user is-active diaria-beehiiv-backup.timer` devolve `active`, próximo disparo domingo 2026-08-16 06:00:00 UTC.
