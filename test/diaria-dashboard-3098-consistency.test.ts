 ...
 *
 * Nota (self-review follow-up): as 3 PRs originais de #3098 foram
 * squash-mergeadas pelo coordenador ANTES do self-review (max effort, 10
 * ângulos) terminar de rodar — os achados abaixo foram aplicados num PR de
 * follow-up separado, direto contra o master pós-merge.
 */
...
test("#3098 (self-review): janela fora de ordem (não confia no produtor) ainda calcula oldest/newest corretamente", () => {
  // Ordem embaralhada de propósito — renderOvernightSection (mesmo arquivo) também
