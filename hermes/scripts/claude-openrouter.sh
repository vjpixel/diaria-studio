...
# caso de uso). laguna segue em segundo — livre de #6617 (z-ai/glm-5.2:free
# saiu do catálogo do OpenRouter, confirmado ao vivo em /api/v1/models,
# 28/08/2026). glm-5.3-flash (pago) continua por último, é o fallback.
