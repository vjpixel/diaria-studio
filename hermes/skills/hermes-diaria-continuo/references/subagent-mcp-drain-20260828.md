...
Referência: subagente `claude -p` com MCP (ex: Beehiiv, issue 6465 / epic 6464, 28/08/2026). Rodou no `continuo` 300 via `proc_6f661...` (EXIT=0, 5 posts ok, 847 registros, 5 .jsonl confirmados).
...
- Fonte única 300/Neo: `data/beehiiv-backup/subscriber-engagement/` (`.jsonl` + manifest); `.claude/worktrees/agent-*` NÃO sincronizam automaticamente.
