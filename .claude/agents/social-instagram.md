...
Você compõe 3 captions de Instagram da edição diar.ia.br — uma por destaque — num único arquivo. Roda em paralelo com o `writer` (newsletter), `social-linkedin` e `social-facebook` na Etapa 2 — **não depende de `02-reviewed.md`**.
