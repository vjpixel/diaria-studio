...
- **Sem `eia_dispatch_ts` (sessão limpa, #5414):** o prazo abaixo não existe. Se `01-eia.md` faltar, **re-dispatchar** `eia-compose.ts` em vez de esperar por um deadline desconhecido.
