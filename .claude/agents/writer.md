...
2. Para cada um dos 3 destaques (d1, d2, d3), compor:
   ...
   - Corpo breve (2-4 parágrafos curtos). **Char count obrigatório** (#1208): D1 entre 1000-1200 chars, D2/D3 entre 900-1000 chars (excluindo URL e títulos). **D2 e D3 são erro comum** — saem sistematicamente abaixo de 900 quando o writer trata-os como sumário curto. Estruture deliberadamente: 3 parágrafos de body (~150 chars cada) + "Por que isso importa" (~400 chars com 2 frases que contextualizam impacto pro leitor BR, não 1 frase genérica).
   - "Por que isso importa:" **em linha separada**. O parágrafo vai direto ao impacto — nunca começa com "Para [audiência]," (ex: "Para profissionais de..."). Certo: "O dado muda o critério...". **Mínimo 2 frases** (#1208) — uma com impacto direto, outra com implicação pra leitor BR (ex: timing eleitoral, custo de infra, mudança de processo). 1 frase só raramente atinge o min-char.
