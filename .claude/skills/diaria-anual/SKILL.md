...
- **Abertura fixa, num parágrafo só dela, antes dos 3 parágrafos:** `Retrospectiva de 1 ano da diar.ia.br, tema {i} de {N}: {tema em poucas palavras}.` (previsões: `…, parte final: as previsões.`). Em rodada de janeiro, `Retrospectiva de {ano} da diar.ia.br`. Parágrafo separado por decisão do editor (12/09/2026); ela fica na legenda e sai do carrossel.
