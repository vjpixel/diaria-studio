...
`/diaria-eai YYYY-MM-DD`

Se não passar data, usa a data de hoje.

## O que faz

1. Detecta a edição em `data/editions/{YYMMDD}/` (precisa ter `02-reviewed.md` pronto).
...
- Para rodar como parte do pipeline completo, use `/diaria-edicao` — ele chama este stage automaticamente.
