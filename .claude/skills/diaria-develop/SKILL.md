...
Sem `gh`/rede: degrada sozinho pra warning + `exit 0` (#738), **dizendo explicitamente que não é um veredito de "sem resíduo"** — o gate não rodou. `plan.json` ausente/ilegível é erro duro (`exit 2`), como o gate acima.
