...
| **Paralelização** | **também paraleliza desde o #6299** — mesma análise de cluster, teto **3** (menor porque roda desassistido). Só o MERGE é serial | **paraleliza tudo que for seguro**; issues que colidem em arquivo **fundem numa unidade só** (1 PR, `Closes` múltiplo) em vez de serializar em ondas (#4319) — teto de 6 worktrees |
