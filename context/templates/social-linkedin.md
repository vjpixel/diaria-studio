...
- **Sem URL no body** (#595) — LinkedIn deprioriza posts com link externo.
- **Sem qualquer menção a diar.ia.br** no main post (decisão editorial 2026-05-08). Nem CTA, nem branding, nem URL textual. Main post é 100% editorial.
...
- **Não mencionar "diar.ia.br"** no main post — main fica 100% editorial, sem branding/CTA.
