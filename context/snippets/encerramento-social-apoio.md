...
Texto aprovado pelo editor em 260710, extraído da campanha mensal 2606-07
enviada manualmente (ajuste feito direto na campanha, fora do template/repo).
Mesmo padrão do #2866: um ajuste de redação aprovado numa edição específica
vira fonte canônica permanente.

Marcador `{{OPENING}}` no início do parágrafo de apoio é substituído conforme
o formato (a frase de apoio em si — "Quem quiser apoiar..." — é IDÊNTICA nos
dois formatos; só a cláusula de abertura muda):
